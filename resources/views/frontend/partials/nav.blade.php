...
@if(count($coupons) > 0)
    <div class="container">
        <div class="position-relative border background p-1" style="border-top: none !important;">
...
@endif
    <div class="d-none top_bar"></div>
    <!-- Header Main start -->
    <div class="header_main">
        <div class="container">
            <div class="row">
                <!-- Logo -->
                <div class="col-lg-3 col-5 order-lg-1 order-1">
                    <div class="logo_container">
                        <div class="logo nav_logoo"><a href="{{ route('index') }}" title="HOME"><img class="man_lazy" src="{{ asset('public/lazy_load.png') }}" data-src="{{ asset('public/images/settings/'.$site_setting->logo) }}"></a></div>
                    </div>
                </div>

                <!-- Search -->
                <div class="col-lg-6 col-12 text-lg-left text-right order-lg-2 order-3">
                ...
                <!--user content-->
                <div class="col-lg-3 col-7 order-lg-3 order-2">
                    <div class="wishlist_cart">
                        ...
                        <!-- App -->
                        <a href="{{asset('public/front/app/Grand Bazaar_1_1.0.apk')}}" class="app_download_icons">
